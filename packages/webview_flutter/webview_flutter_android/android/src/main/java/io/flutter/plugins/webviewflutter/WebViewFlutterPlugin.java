...
import io.flutter.plugins.webviewflutter.newGen.ConsoleMessageApiImpl;
import io.flutter.plugins.webviewflutter.newGen.ConsoleMessage_Api;
import io.flutter.plugins.webviewflutter.newGen.CookieManagerApiImpl;
...
import io.flutter.plugins.webviewflutter.newGen.WebResourceErrorApiImpl;
import io.flutter.plugins.webviewflutter.newGen.WebResourceError_Api;
import io.flutter.plugins.webviewflutter.newGen.WebResourceRequestApiImpl;
...
import io.flutter.plugins.webviewflutter.newGen.WebViewPointApiImpl;
...
public class WebViewFlutterPlugin implements FlutterPlugin, ActivityAware {
  ...
  static class ProxyApiCodec extends Pigeon_ProxyApiBaseCodec {
    ...
    public WebResourceRequest_Api getWebResourceRequest_Api() {
      return new WebResourceRequestApiImpl(this);
    }
    ...
    public WebResourceError_Api getWebResourceError_Api() {
      return new WebResourceErrorApiImpl(this);
    }

    @NonNull
    @Override
    public WebViewPoint_Api getWebViewPoint_Api() {
      return new WebViewPointApiImpl(this);
    }

    @NonNull
    @Override
    public ConsoleMessage_Api getConsoleMessage_Api() {
      return new ConsoleMessageApiImpl(this);
    }

    @NonNull
    @Override
    public CookieManager_Api getCookieManager_Api() {
      return new CookieManagerApiImpl(this);
    }
