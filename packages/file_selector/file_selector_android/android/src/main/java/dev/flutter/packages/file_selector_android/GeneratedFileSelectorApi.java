...
public class GeneratedFileSelectorApi {
  ...
  public interface FileSelectorApi {
     ...
     */
    void openFile(@Nullable String initialDirectory, @NonNull FileTypes allowedTypes, @NonNull NullableResult<String> result);
    /**
     * Opens a file dialog for loading files and returns a list of file responses
     * chosen by the user.
     */
    void openFiles(@Nullable String initialDirectory, @NonNull FileTypes allowedTypes, @NonNull Result<List<String>> result);
    /**
