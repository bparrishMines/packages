...
public class GeneratedFileSelectorApi {
  ...
  public static final class FileSelectorNativeException {
    ...
    public boolean equals(Object o) {
      ...
      return pigeonDeepEquals(fileSelectorExceptionCode, that.fileSelectorExceptionCode)
          && pigeonDeepEquals(message, that.message);
    }

    @Override
    public int hashCode() {
      Object[] fields = new Object[] {getClass(), fileSelectorExceptionCode, message};
  ...
  public static final class FileResponse {
    ...
    public boolean equals(Object o) {
      ...
      return pigeonDeepEquals(path, that.path)
          && pigeonDeepEquals(mimeType, that.mimeType)
          && pigeonDeepEquals(name, that.name)
          && pigeonDeepEquals(size, that.size)
          && pigeonDeepEquals(bytes, that.bytes)
          && pigeonDeepEquals(fileSelectorNativeException, that.fileSelectorNativeException);
    }

    @Override
    public int hashCode() {
      Object[] fields =
          new Object[] {getClass(), path, mimeType, name, size, bytes, fileSelectorNativeException};
      return pigeonDeepHashCode(fields);
    }
  ...
  public static final class FileTypes {
    ...
    public boolean equals(Object o) {
      ...
      return pigeonDeepEquals(mimeTypes, that.mimeTypes)
          && pigeonDeepEquals(extensions, that.extensions);
    }

    @Override
    public int hashCode() {
      Object[] fields = new Object[] {getClass(), mimeTypes, extensions};
      return pigeonDeepHashCode(fields);
    }
  ...
  public interface FileSelectorApi {
    ...
    void openFile(
        ...
        @NonNull NullableResult<String> result);
